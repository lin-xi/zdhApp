app.controller('ChatController', function(){
	...
	function sendMessage(msg){
		$('<div class="send-msg"><span class="msg-holder">'+ msg +'</span><img class="user-avatar" width="50" height="50" src="static/images/avatar.jpg"/></div>').appendTo(cl);
	}

	function receiveMessage(){
		$('<div class="recv-msg"><span class="msg-holder">'+ msg +'</span><img class="user-avatar" width="50" height="50" src="static/images/shop/huoguo4.png"/></div>').appendTo(cl);
	}
